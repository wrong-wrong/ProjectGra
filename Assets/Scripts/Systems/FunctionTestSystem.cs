...
//            var variableSystem = World.DefaultGameObjectInjectionWorld.GetOrCreateSystemManaged<VariableRateSimulationSystemGroup>();
//            variableSystem.RateManager = new RateUtils.VariableRateManager(1000);
//        }
